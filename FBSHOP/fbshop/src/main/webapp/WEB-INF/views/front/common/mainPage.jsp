...
<link href="<%=request.getContextPath()%>/resources/css/mainPage.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="content_home" >
	<div id="homeing">
		<a href="/"><img src="<%=request.getContextPath()%>/resources/image/banner2.jpg" style="height:100px;"/></a>
	</div>
	<br/>
	...
	<ul>
		<li><a href="#"><img src="<%=request.getContextPath()%>/resources/image/banner.png" style= "max-width:909px;"/></a></li>
		<li><a href="#"><img src="<%=request.getContextPath()%>/resources/image/banner.png" style= "max-width:909px;"/></a></li>
		<li><a href="#"><img src="<%=request.getContextPath()%>/resources/image/banner.png" style= "max-width:909px;"/></a></li>
		<li><a href="#"><img src="<%=request.getContextPath()%>/resources/image/banner.png" style= "max-width:909px;"/></a></li>
	</ul>
	...
	<ul>
		...
		<li>
			<a href="#none"><dl><dt><img src="<%=request.getContextPath()%>/resources/image/A.png" style="height:150px;"/></dt><dd>Arsnal 17/18 home kit</dd><dd>price: 100,000 </dd></dl></a>
		</li>
